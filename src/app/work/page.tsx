...
const Page = () => {
  ...
  const workPageContainer = useRef<HTMLDivElement>(null);
  ...
  useGSAP(
    () => {
      ...
      const folders = q(".folder") as HTMLElement[];
      const folderWrappers = q(".folder-wrapper") as HTMLElement[];
      ...
      const mouseEnterHandlers = new Map<HTMLElement, () => void>();
