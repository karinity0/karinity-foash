...
const Menu = ({ pageRef }: MenuProps) => {
  ...
  useEffect(() => {
    ...
    menuCols.forEach((col) => {
      ...
      const elements = col.querySelectorAll("p, a") as NodeListOf<HTMLElement>;
  ...
  useGSAP(
    () => {
      ...
      menuLinks.forEach((link) => {
        ...
        const chars = link.querySelectorAll("span") as NodeListOf<HTMLElement>;
      ...
      menuLinkContainers.forEach((link) => {
        ...
        const handleMouseEnter = () => {
          ...
          const linkCopy = link.querySelectorAll(
            "a span"
          ...
          const visibleChars = visibleCopy.querySelectorAll(
            ".char"
          ) as NodeListOf<HTMLElement>;
          ...
          const animatedChars = animatedCopy.querySelectorAll(
            ".char"
          ) as NodeListOf<HTMLElement>;
          ...
          const linkCopyElement = link.querySelector("a span") as HTMLElement;
      ...
      const handleMenuLinksWrapperMouseLeave = () => {
        ...
        const defaultLinkTextSpan = defaultLinkText.querySelector(
          "a span"
        ) as HTMLElement;
  ...
  const toggleMenu = () => {
    ...
    if (!isMenuOpen) {
      ...
      menuCols.forEach((col) => {
        ...
        const splitLines = col.querySelectorAll(
          ".split-line"
        ) as NodeListOf<HTMLElement>;
  ...
  return (
    <>
      <nav className="grid grid-cols-2 items-center content-center w-full mix-blend-difference">
        {/* Both Logos */}
        <div
          onClick={() => {
        ...
        <div
          className="nav-toggle justify-self-end"
          ref={navToggleRef}
          onClick={toggleMenu}
        >
          <div className="nav-toggle-wrapper">
            <p ref={openLabelRef} className="open-label text-black!">
              Menu
            </p>

            <p ref={closeLabelRef} className="close-label text-black!">
              Close
            </p>
          </div>
        </div>
        ...
        <div className="menu-content">
          ...
          >
            <div className="menu-content-group">
              ...
              <a
                href="https://www.instagram.com/karim_khaled16/"
                target="_blank"
              ...
              <a
                href="https://www.facebook.com/foash15"
                target="_blank"
                rel="noopener noreferrer"
              >
                Facebook
