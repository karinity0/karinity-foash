...
export default function StorySlides() {
  ...
  useEffect(() => {
    ...
    function cleanUpElements() {
      const profileNameDiv = storiesContainer.querySelector(
        ".profile-name"
      ) as HTMLElement;
      const titleRows = storiesContainer.querySelectorAll(
        ".title-row"
    ...
    function changeStory() {
      ...
      const currentImg = currentImgContainer.querySelector(
        "img"
      ) as HTMLImageElement;
      if (!currentImg) {
        isAnimating = false;
      ...
      setTimeout(() => {
        ...
        const storyImgDiv = storiesContainer.querySelector(
          ".story-img"
        ) as HTMLElement;
        if (storyImgDiv) {
      ...
      setTimeout(() => {
        ...
        const link = storiesContainer.querySelector(
          ".link a"
