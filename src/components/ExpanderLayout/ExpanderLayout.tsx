...
const STUCK_CARD_INDEX: number | null = null;
...
const ExpanderLayout = () => {
  ...
  useGSAP(() => {
    ...
    const handleCardHover = (hoveredIndex: number) => {
    ...
    const handleCardHoverDebounced = (hoveredIndex: number) => {
    ...
    const hoverHandlers = cards
      .map((card, index) => {
        ...
        (card as any)._mouseEnterHandler = enterHandler;
        (card as any)._mouseLeaveHandler = leaveHandler;
